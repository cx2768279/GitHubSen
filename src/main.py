...
def export_daily_report(args, report_generator):
...
def main():
    ...
    parser_export = subparsers.add_parser('export', help='Export daily progress to a file')
    parser_export.add_argument('export',type=str, help='export daily progress to a file')
